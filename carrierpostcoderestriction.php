...
class Carrierpostcoderestriction extends Module
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Carrier Postcode Restriction');
        $this->description = $this->l('Restrict carrier options according to delivery address postcode');
            ...
            'form' => array(
                ...
                'input' => array(
                    array(
                        ...
                        'name' => 'CARRIERPOSTCODERESTRICTION_LIVE_MODE',
                        'is_bool' => true,
